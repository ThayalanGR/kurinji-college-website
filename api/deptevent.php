...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['method'] === 'post') {
        ...
        if ($isBodyContainsImage === 'true') {
            ...
            if (!is_dir("./uploads/deptevent")) {
                mkdir("./uploads/deptevent");
            }
            if (move_uploaded_file($fileTmpLoc, "./uploads/deptevent/$fileName")) {
                $sql = "INSERT INTO `tbl_deptevent` (`title`, `body`, `imagepath`, `dept`) VALUES ('" . $title . "', '" . $body . "','/api/uploads/deptevent/" . $fileName . "', '" . $department . "')";
                mysqli_query($DB, $sql);
                echo json_encode($sql);
            }
        } else {
            $sql = "INSERT INTO `tbl_deptevent` (`title`, `body`, `imagepath`, `dept`) VALUES ('" . $title . "', '" . $body . "', 'null', '" . $department . "')";
            mysqli_query($DB, $sql);
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['department'])) {
        ...
        $queryString = "SELECT * from tbl_deptevent ORDER BY id ASC";
