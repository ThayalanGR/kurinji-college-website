...
export default class Deptlab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      eventTitle: "",
  ...
  fetchEvents(filterChoice) {
    ...
    if (filterChoice === "all") {
      ...
      axios
        .get(`${baseUrl}/api/deptlab.php?department=${filterChoice}`)
        .then(data => {
          this.setState({ existingEvents: data.data });
        })
        .catch(err => console.log(err));
  ...
  addNewEvent() {
    if (
      ...
      document.getElementById("hasImagelab").checked = false;
      this.setState({
        eventTitle: "",
        eventBody: "",
        eventDepartment: "",
      ...
      <div className="container-fluid p-2">
        <div className="row mtspace ">
          <div className="col text-center text-danger h5">
            Department Wise Laboratories Upload Section
            <hr />
          </div>
        </div>
        <div className="row" style={{ maxWidth: "100vw" }}>
          <div className="col-md-6 " style={{ width: "100%" }}>
            <div className="text-center text-danger">Add new Laboratories</div>
            ...
            <div className="d-flex justify-content-center">
              <form className="" style={{ width: "350px" }}>
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Laboratory Title</label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Laboratory Body</label>
                  <textarea
                    className="form-control"
                    id="validationTextarea"
                    placeholder="Required  textarea"
                ...
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Laboratory Department</label>
                  <select
                    name=""
                    className="form-control"
                ...
                <div className="mb-3 d-flex justify-content-around align-items-center">
                  <div>Is Laboratory has Image ?</div>
                  <input
                    type="checkbox"
          ...
          <div className="col-md-6">
            <div className="text-center d-flex justify-content-around">
              ...
              <div className="text-danger">Existing Laboratories</div>
