...
export default class Deptevent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      eventTitle: "",
  ...
  fetchEvents(filterChoice) {
    ...
    if (filterChoice === "all") {
      ...
      axios
        .get(`${baseUrl}/api/deptevent.php?department=${filterChoice}`)
        .then(data => {
          this.setState({ existingEvents: data.data });
        })
        .catch(err => console.log(err));
      ...
      <div className="container-fluid p-2">
        <div className="row mtspace ">
          <div className="col text-center text-danger h5">
            Department Wise Event Upload Section
            <hr />
          </div>
        </div>
        <div className="row" style={{ maxWidth: "100vw" }}>
          <div className="col-md-6 " style={{ width: "100%" }}>
            ...
            <div className="d-flex justify-content-center">
              <form className="" style={{ width: "350px" }}>
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Event Title</label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Event Body</label>
                  <textarea
                    className="form-control"
                    id="validationTextarea"
                    placeholder="Required  textarea"
                ...
                <div className="mb-3">
                  <label htmlFor="validationTextarea ">Event Department</label>
                  <select
                    name=""
                    className="form-control"
          ...
          <div className="col-md-6">
            <div className="text-center d-flex justify-content-around">
              ...
              <div className="text-danger">Existing events</div>
