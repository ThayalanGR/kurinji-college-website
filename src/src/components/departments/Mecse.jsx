...
export default class mecse extends Component {
  constructor(props) {
    ...
    this.hideMecseDepartmentNavbar = this.hideMecseDepartmentNavbar.bind(this);
  }
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col">
            ...
            <div className="text-left">
              Department of Computer Science and Engineering strives to ensure
              quality education as a leader in the Computer Science and
              Engineering Education by continuously improving academic inputs
  ...
  hideMecseDepartmentNavbar() {
    this.state.showMenu === ""
      ? this.setState({ showMenu: "d-none-custom" })
      : this.setState({ showMenu: "" });
    document.removeEventListener("click", this.hideMecseDepartmentNavbar);
  }
            ...
            <i
              onClick={e => {
                ...
                document.addEventListener(
                  "click",
                  this.hideMecseDepartmentNavbar
                );
              }}
